...
import { DropdownItem, DropdownMenu, DropdownToggle, Row, Col, UncontrolledDropdown } from 'reactstrap';
                    ...
                    <div className="card-header border-0 align-items-center d-flex">
                        ...
                        <div>
                            ...
                            <UncontrolledDropdown direction='start'>
                                <span tag="button" className="btn btn-success btn-sm">
                                    <i className="ri-arrow-right-up-line">In</i>
                                    {/* If Out: badge: "ri-arrow-right-down-line", */}
                                </span>
