...
import HRReportsSalary from "./HrReportsSalaried"
import HRReportsHourly from "./HrReportsHourly";

const HRReportsTimelineTabs = () => {
    const [activeTab, setActiveTab] = useState("1");

    const tabs = [
        {
            id: "1",
            label: "HR Reports - Salaried",
            icon: "ri-todo-fill",
            component: <HRReportsSalary />
        },
        {
            id: "2",
            label: "HR Reports - Hourly",
            icon: "ri-todo-fill",
            component: <HRReportsHourly />
        }
    ];
...
export default HRReportsTimelineTabs;
